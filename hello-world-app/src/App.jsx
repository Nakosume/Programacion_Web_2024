    ...
    return (
        ...
        <div className="appContainer">
            ...
            <div style={{
                ...
                <Body color='black' content='Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo numquam nobis iure eum expedita explicabo quidem! Modi itaque obcaecati id dolor, porro, voluptates minus ab quo, recusandae earum magnam. Voluptatibus maiores pariatur itaque ipsa fugiat culpa soluta debitis commodi repellendus quam rem voluptate corrupti, excepturi aperiam dolore eligendi quaerat cupiditate vitae doloribus, perspiciatis libero quidem ab optio illum. Tenetur aliquam hic maiores veritatis quod sint voluptatum, incidunt tempora? Alias delectus veniam, nisi eius iusto maxime. Quos fugit provident, deleniti fuga omnis ex officiis reprehenderit neque, nam modi quo, earum veritatis maiores iste sapiente dolore necessitatibus vel doloribus laudantium! Id, rerum blanditiis hic nihil dolore quas pariatur. Ex voluptate beatae cumque animi quia maxime consequatur molestias ullam facere voluptates doloremque necessitatibus dolorum explicabo error, perspiciatis itaque reiciendis culpa suscipit?'></Body>
